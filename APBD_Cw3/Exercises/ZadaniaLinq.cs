...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        return new[] { czyIstnieje ? "Tak" : "Nie" };
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        ...
        return new[] { czyWszyscyMaja ? "Tak" : "Nie" };
    }
    ...
    {
        int liczbaZapisow = DaneUczelni.Zapisy.Count(z => z.CzyAktywny);
        return new[] { liczbaZapisow.ToString() };
    }
    ...
    public IEnumerable<string> Zadanie11_PolaczStudentowIZapisy()
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy,
                  s => s.Id,
                  z => z.StudentId,
                  (s, z) => $"{s.Imie} {s.Nazwisko} | Zapis: {z.DataZapisu:yyyy-MM-dd}");
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Studenci
            ...
            .SelectMany(
                temp => DaneUczelni.Przedmioty.Where(p => p.Id == temp.Zapis.PrzedmiotId),
                (temp, p) => $"{temp.Student.Imie} {temp.Student.Nazwisko} - {p.Nazwa}"
            );
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty, z => z.PrzedmiotId, p => p.Id, (z, p) => new { p.Nazwa, Ocena = z.OcenaKoncowa!.Value })
            .GroupBy(temp => temp.Nazwa)
            .Select(g => $"{g.Key} | Średnia ocena: {g.Average(x => x.Ocena):F2}");
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(DaneUczelni.Przedmioty, 
                       pr => pr.Id, 
                       p => p.ProwadzacyId, 
                       (pr, przedmioty) => new { pr.Imie, pr.Nazwisko, Liczba = przedmioty.Count() })
            .Select(x => $"{x.Imie} {x.Nazwisko} | Liczba przedmiotów: {x.Liczba}");
    }
    ...
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy.Where(z => z.OcenaKoncowa.HasValue), s => s.Id, z => z.StudentId, (s, z) => new { s.Imie, s.Nazwisko, Ocena = z.OcenaKoncowa!.Value })
    ...
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy.Where(z => z.CzyAktywny), s => s.Id, z => z.StudentId, (s, z) => new { s.Imie, s.Nazwisko })
            .GroupBy(temp => new { temp.Imie, temp.Nazwisko })
            .Where(g => g.Count() > 1)
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Join(DaneUczelni.Zapisy, p => p.Id, z => z.PrzedmiotId, (p, z) => new { p.Nazwa, z.OcenaKoncowa })
            .GroupBy(temp => temp.Nazwa)
            .Where(g => g.All(x => !x.OcenaKoncowa.HasValue))
            .Select(g => g.Key);
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            .Select(pr => new
            {
                Prowadzacy = $"{pr.Imie} {pr.Nazwisko}",
            ...
            .Select(x => $"{x.Prowadzacy} | Średnia: {(x.Oceny.Any() ? x.Oceny.Average().ToString("F2") : "Brak ocen")}");
    }
